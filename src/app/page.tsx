  ...
  return (
    <>
      ...
      <div className="font-[family-name:var(--font-inter)]">
        {/* ── NAV ─────────────────────────────────────────────────────────── */}
        <nav className="fixed top-0 z-50 flex w-full items-center justify-between px-8 py-4 backdrop-blur-md bg-white/80 border-b border-slate-200/60">
      ...
      {/* ── HERO ────────────────────────────────────────────────────────── */}
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-amber-50 via-white to-slate-50 px-6 pt-20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100/40 via-transparent to-transparent" />

        <div className="relative z-10 flex max-w-4xl flex-col items-center text-center">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-amber-300 bg-amber-100 px-4 py-1.5 text-xs font-medium tracking-wide text-amber-700 uppercase">
      ...
      <section
        id="meet-sam"
        className="relative bg-white px-6 py-40"
      >
        ...
        <div className="relative mx-auto max-w-6xl">
          <ScrollReveal>
            <div className="mb-20 text-center">
              ...
              <h2 className="mt-4 font-[family-name:var(--font-playfair)] text-5xl font-medium leading-tight tracking-tight text-slate-900 sm:text-6xl md:text-7xl">
                Meet Sam.
              </h2>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal delay={400}>
              <div className="space-y-6">
                <p className="text-xl leading-relaxed text-slate-700">
                  ...
                  memorized every page of your poll worker training manual.
                </p>
                <p className="text-lg leading-relaxed text-slate-600">
                  Ask about voter check-in, provisional ballots, accessibility
                  procedures, or emergency protocols. Every answer cites the exact
                  section from your official documents.
                </p>
                <p className="text-lg leading-relaxed text-slate-600">
                  Sam supports English and Spanish, and never strays outside
                  approved election content.
                </p>
                <Link
                  href="/chat"
                  className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-amber-600 transition-colors hover:text-amber-700"
                >
                  Talk to Sam
                  <svg
                    className="h-4 w-4"
      ...
      <section className="relative bg-slate-50 px-6 py-40">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2">
            ...
            <div className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:border-amber-300 hover:shadow-lg hover:shadow-amber-100/50">
            ...
            {/* Card 2 */}
            <ScrollReveal delay={200}>
            <div className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:border-blue-300 hover:shadow-lg hover:shadow-blue-100/50">
            ...
            <div className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-100/50">
            ...
            {/* Card 4 */}
            <ScrollReveal delay={400}>
            <div className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:border-violet-300 hover:shadow-lg hover:shadow-violet-100/50">
